...
Korú é um mundo cuja física é baseada em memória. Antes de qualquer atualização, leia `koru-ecosystem-briefing.md` completo para ter o contexto atual.

## Regras inegociáveis de Korú (nunca violar)
...
- Luz azul-fria, não dourada. Responsiva à emoção, não constante.
- Herança física de Oruku (frequência de "passagem presa"), não herança sentimental.

**As 13 regras:**
- Não criar regras novas sem verificar se conflitam com as 13 existentes.
...
2. Identifique onde o novo elemento se encaixa na estrutura das 8 partes
3. Verifique se o novo elemento conflita com algo existente
4. Se conflitar: apontar o conflito para a autora antes de editar
5. Se for consistente: integrar na seção correta, mantendo o tom documental técnico
6. Atualizar a tabela de atualizações no `koru-workflow.md`
