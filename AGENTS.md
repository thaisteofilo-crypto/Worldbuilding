...
.Codex/agents/             , bible-keeper, conto-writer, book-writer
.Codex/commands/           , /write-conto, /expand-chapter, /update-bible
.Codex/skills/voz-thais/   , skill de voz da autora
```
...
Ao escrever qualquer texto narrativo, o agente relevante deve ler `.Codex/skills/voz-thais/SKILL.md` primeiro.
...
Ver `.Codex/skills/voz-thais/SKILL.md` para exemplos detalhados com ✅/❌.
