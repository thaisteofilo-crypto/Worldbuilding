...
**Espécie:** Onkweri. Quadrúpede com chifres. Nômade. Apoio.
**Status atual:** Viva, em movimento. Atravessa o Bomi-Weh (planícies sem Ariku) entre Chi-Oa, sem se fixar em nenhum.
**Aparições:**
- `koru-ecosystem-briefing.md`
- `biblia/parte-05-personagens.md` (ficha completa)
- `contos/conto-temi.md` (protagonista, narra travessia das planícies em direção a Orunjó)
- `livro/epilogo.md` (papel narrativo: Kanda de Temi para Temiku)
...
### Costa
Ancas regulares, quarto traseiro com a mesma estratificação irregular dos flancos. Cauda curta. A linha do dorso tem variação leve por causa das camadas em ângulos. Cor uniformemente mais clara que Onkweri de cidade.
...
- **Sem marcas de Isilo-Ori**.
- **Sem luz própria**.
- O traço-chave é a **irregularidade da estratificação**: o oposto da regularidade extrema de Beku/Obaru. Mostrar visivelmente que as camadas vão em direções diferentes.
- A **leveza** dela não é ausência de peso (é Onkweri, deixa rastro), é sincronismo. Não desenhar como criatura "flutuante" ou "etérea". Ela tem peso, distribuído.
...
Lighting from above. Style left open for the artist. Reference vocabulary: nomadic quadruped morphology, multi-angle layered hide, lighter open-plains coloration, fluid weighted gait, adapted horn structure.
