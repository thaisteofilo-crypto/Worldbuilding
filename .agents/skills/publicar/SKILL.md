...
- `prompt`: instrua o agente a seguir as regras de `.Codex/agents/koru-publisher.md`. Se houver mensagem custom (após `/publicar mensagem aqui`), passe-a como sugestão de título do commit.
