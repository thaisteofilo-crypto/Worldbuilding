...
const GROUPS: GroupDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "section.biblia.description", label: "Bíblia — Descrição" },
      { key: "section.personagens.description", label: "Personagens — Descrição" },
      { key: "section.contos.description", label: "Contos — Descrição" },
      { key: "section.livro.description", label: "Livro — Descrição" },
    ],
  },
  {
    id: "footer",
