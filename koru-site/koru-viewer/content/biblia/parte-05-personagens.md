...
**Etimologia:** nome registrado como ocorrência, não como composição de raízes Korú. Kairo não foi nomeada pelo mundo. Não há radical Yoruba, Igbo, Swahili ou Bambara associado.

**Espécie:** humana. Biológica (carbono, água, respiração). Bípede.

**Era de ocorrência:** Era VI. Primeira instância documentada de ser humano em Korú.

**Status:** viva, localizável. Vagueia pelo Rimba Ngozi. Sem destinatário para a memória que deposita.

---

**ORIGEM:**

Kairo não emergiu do Bomi Veh nem foi gerada por acordo fundador. Atravessou o teto do Akwu pela fratura que marcou o fim da Era V e o início da Era VI (costura solta sobre o Rimba Ngozi, gerada pela reverberação cosmológica da restauração do Bomi Veh por Temiku). Matéria externa entrou sem declaração; o sistema não registrou frequência de entrada.

**Implicações do modo de entrada:**
- É a primeira criatura viva em Korú cuja origem está **fora do Akwu**.
- Tem origem de passagem, não de lugar (como Onkweri) nem de evento (como Temiku).
- O acordo fundador não prevê entrada externa. Kairo existe como instância para a qual o mundo não tem protocolo.

*Ver [Parte 8, Era VI](parte-08-linha-do-tempo.md) para o evento cosmológico da ruptura.*
...
| Atributo | Descrição |
|---|---|
| Postura | Bípede, ereta |
| Membros superiores | Braços com mãos de cinco dedos. Palmas com linhas. **Única criatura do elenco com palmas.** |
| Pele | Lisa, sem chifres, sem cascos, sem estratificação. Suscetível à luz Oru pleno sem mediação das Ariku (queimadura direta) |
| Fronte | Sem chifres, sem marca de Isilo-Ori possível. Fronte lisa, não funcional para contato de transmissão |
| Locomoção | Dois pés com pressão concentrada em superfície pequena, contato com o solo distinto do casco distribuído |
| Luz própria | Ausente. Sem Luz Limiar, sem fosforescência, sem herança de frequência |

**Paleta:** pele em tons que não correspondem a nenhuma paleta do Akwu. Referência de contraste: próxima ao bege-areia seca, sem a densidade de carvão dos Onkweri nem o branco-lilás translúcido dos Azuri.

---

**PROPRIEDADE COSMOLÓGICA ÚNICA:**

Kairo é **não-leitura pelo sistema.** O Akwu não tem protocolo para processar sua presença.

| Interação | Resposta do sistema |
|---|---|
| Rastro no Bomi Veh ao pisar | Lilás volta ao padrão habitual em minutos. **Não deixa pegadas duradouras.** |
| Contato de palma com o solo | Bomi Veh fica **cinza neutro** no formato exato da palma. Não é preto (Ubomi-chi não morreu) nem saturado sem rota (ciclo não travou). É **não-categoria:** solo que tentou ler e não conseguiu. |
| Emissão de Zoeji | Nenhuma. O tempo espiral não a registra. |
| Contato com Ariku pela testa | Impossível. Fronte sem frequência compatível. Ariku não recebe. |
| Contato com Azuri | Não dissolve (Regra 08 inoperante). Sem substrato reconhecível, o mecanismo de dissolução não inicia. |
| Toque de eleição | Impossível (Regra 10 inoperante). Sem frequência emissiva a ajustar. |
| Comunicação possível | Apenas via **Fala-Fora** com Azuri (voz atravessando o ar, sem transmissão pela testa). |
| Memória | **Esquece.** Memória humana apaga com o tempo. Única criatura de Korú que perde registro por atrito temporal, não por dissolução nem sobrescrição. |
| Morte (quando ocorrer) | Nada será processado nem registrado. Sem Bomi Veh que digira, sem Ariku que arquive, sem Azuri que traduza. Dissolução de sentido, não de matéria. |

---

**SUSTENTO:**

Kairo sobrevive de Kanda cru (frutos e raízes que podem ser ingeridos sem preparo) encontrados no Rimba Ngozi. Não absorve frequência do Bomi Veh como os Onkweri; depende de matéria biológica convencional.

---

**RELAÇÕES:**

- **Com Temiku:** contraponto simétrico. Temiku = excesso de memória (dissolve por acúmulo de Luz Limiar sobre base Onkweri). Kairo = ausência de memória (passa sem marcar). As duas existem como evidência de que o acordo tem bordas.
- **Com o Akwu:** o sistema não a rejeita (não tem protocolo para rejeitar o que não lê) nem a sustenta no tempo longo. Permanência temporária por física, não por decisão.
- **Com os Azuri:** único canal de comunicação possível é Fala-Fora. Sem troca por testa, sem eleição.

---

**FUNÇÃO NARRATIVA:**

Kairo é o primeiro sinal da Era VI. Símbolo da chegada do que o mundo ainda não aprendeu a integrar. Onde Temiku prova que o acordo tem buracos processáveis, Kairo prova que há entradas que o acordo sequer tenta processar.

*Para o caso do 6º estado do Bomi Veh (Saturado sem rota, categoria geral reconhecida após a restauração da Era V), ver [Parte 3](parte-03-ecossistema.md). O cinza neutro sob a palma de Kairo é estado distinto: não-categoria, não instância de 4º/5º estado.*
